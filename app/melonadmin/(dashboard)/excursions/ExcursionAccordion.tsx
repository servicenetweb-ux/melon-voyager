...
export function ExcursionAccordionList({ children }: { children: ReactNode }) {
...
export function ExcursionAccordionItem({
  id,
  title,
  slug,
  active,
  ...
  if (!context) throw new Error("ExcursionAccordionItem must be inside list.");
